...
FROM customers INNER JOIN addresses where customers.customerID = addresses.customerID
GROUP BY customers.customerID, customers.emailAddress, customers.firstName, customers.lastName,
addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone;';// PUT YOUR SQL QUERY HERE
